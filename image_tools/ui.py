...
class RotateVideoTab(RunnerTab):
    ...
    def _gather_kwargs(self):
        ...
        if music:
            kw["music"] = music
        # The end screen is transposed into portrait like the horizontal
        # photos, so use the horizontal (16:9) template from the selected set.
        end_screen = template_for("16:9", "end-screen",
